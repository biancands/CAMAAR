document.addEventListener("DOMContentLoaded", function () {
    ...
    function criarCard(avaliacao) {
      ...
      // Adiciona o título e o ícone de baixar
      card.innerHTML = `
      ...
      // Adiciona um event listener para o clique no card
      card.addEventListener("click", function () {
        console.log(
          `Resultado sendo baixado da matéria: ${avaliacao.materia} - Professor: ${avaliacao.professor} - Semestre: ${avaliacao.semestre}`
        );
      });
